...
*/
int GLShader::shaderSize(const char *fileName){
    FILE* fd;
    int count = -1;
...
*/
int GLShader::readShader(const char *fileName, char *shaderText, int size){
    FILE *fh;
    int count;
...
*/
int GLShader::readShaderSource(const char *fileName, char **buffer){
    int size;
