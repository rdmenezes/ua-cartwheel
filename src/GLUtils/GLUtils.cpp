...
*/
void GLUtils::drawWireFrameBox(CartWheel::Math::Point3d min, CartWheel::Math::Point3d max){
...
void GLUtils::drawGround(double size, double spotRadius, int nb, const char* sGroundPath){
