...
protected:
	...
	CartWheel::Math::Trajectory1d* trajectory;
...
public:
	...
	*/
	void setTrajectory( CartWheel::Math::Trajectory1d* trajectory ) { this->trajectory = trajectory; }

	const CartWheel::Math::Trajectory1d* getTrajectory() const { return trajectory; }
