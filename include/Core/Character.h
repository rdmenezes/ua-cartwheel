...
*/
class Character : public CartWheel::Physics::ArticulatedFigure {
...
private:
	...
	*/
	void setHeading(CartWheel::Math::Quaternion heading);
...
public:
	...
	*/
	void getRelativeOrientation(int i, CartWheel::Math::Quaternion* qRel);
	...
	*/
	void getRelativeAngularVelocity(int i, CartWheel::Math::Vector3d* wRel);
	...
	*/
	void readReducedStateFromFile(const char* fName, ReducedCharacterStateArray* state);
	...
	*/
	...
	/**
		this method is used to write the reduced state of the character to a file
	*/
	void saveReducedStateToFile(const char* fName, ReducedCharacterStateArray& state);
	...
	*/
	CartWheel::Math::Quaternion getHeading();
	...
	*/
	...
	void setPos(Math::Point3d newLoc);
...
*/
inline CartWheel::Math::Quaternion computeHeading(const CartWheel::Math::Quaternion& rot){
	return rot.getComplexConjugate().decomposeRotation(CartWheel::Physics::PhysicsGlobals::up).getComplexConjugate();
}
...
public:
	...
	*/
	inline CartWheel::Math::Vector3d getPosition(){
		return CartWheel::Math::Vector3d(REDUCED_STATE_VAL(this, 0+startIndex), REDUCED_STATE_VAL(this, 1+startIndex), REDUCED_STATE_VAL(this, 2+startIndex));
	}

	/**
		sets the root position.
	*/
	inline void setPosition(const CartWheel::Math::Vector3d& p){
	...
	*/
	inline CartWheel::Math::Quaternion getOrientation(){
		return CartWheel::Math::Quaternion(REDUCED_STATE_VAL(this, 3+startIndex), REDUCED_STATE_VAL(this, 4+startIndex), REDUCED_STATE_VAL(this, 5+startIndex),  REDUCED_STATE_VAL(this, 6+startIndex));
	}

	/**
		sets the root orientation.
	*/
	inline void setOrientation(const CartWheel::Math::Quaternion& q){
	...
	*/
	inline CartWheel::Math::Vector3d getVelocity(){
		return CartWheel::Math::Vector3d(REDUCED_STATE_VAL(this, 7+startIndex), REDUCED_STATE_VAL(this, 8+startIndex), REDUCED_STATE_VAL(this, 9+startIndex));
	}

	/**
		sets the root velocity.
	*/
	inline void setVelocity(const CartWheel::Math::Vector3d& v){
	...
	*/
	inline CartWheel::Math::Vector3d getAngularVelocity(){
		return CartWheel::Math::Vector3d(REDUCED_STATE_VAL(this, 10+startIndex), REDUCED_STATE_VAL(this, 11+startIndex), REDUCED_STATE_VAL(this, 12+startIndex));
	}

	/**
		sets the root angular velocity.
	*/
	inline void setAngularVelocity(const CartWheel::Math::Vector3d& v){
	...
	*/
	inline CartWheel::Math::Quaternion getJointRelativeOrientation(int jIndex){
		int offset = startIndex + 13 + 7 * jIndex;
		return CartWheel::Math::Quaternion(REDUCED_STATE_VAL(this, 0 + offset), REDUCED_STATE_VAL(this, 1 + offset), REDUCED_STATE_VAL(this, 2 + offset),  REDUCED_STATE_VAL(this, 3 + offset));
	}

	/**
		sets the orientation for joint jIndex
	*/
	inline void setJointRelativeOrientation(const CartWheel::Math::Quaternion& q, int jIndex){
		int offset = startIndex + 13 + 7 * jIndex;
	...
	*/
	inline CartWheel::Math::Vector3d getJointRelativeAngVelocity(int jIndex){
		int offset = startIndex + 13 + 7 * jIndex;
		return CartWheel::Math::Vector3d(REDUCED_STATE_VAL(this, 4 + offset), REDUCED_STATE_VAL(this, 5 + offset), REDUCED_STATE_VAL(this, 6 + offset));
	}

	/**
		sets the orientation for joint jIndex
	*/
	inline void setJointRelativeAngVelocity(const CartWheel::Math::Vector3d& w, int jIndex){
		int offset = startIndex + 13 + 7 * jIndex;
	...
	*/
	inline double raptor_computeDistanceTo(ReducedCharacterState *other){
		...
		double result = 0;
		CartWheel::Math::Quaternion qa, qb;
		CartWheel::Math::Vector3d va, vb;
		...
		for (size_t i=0;i<sizeof(joints)/sizeof(joints[1]);i++){
