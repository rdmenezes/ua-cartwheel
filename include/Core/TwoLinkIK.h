...
public:
	...
	*/
	...
	static void getIKOrientations(const CartWheel::Math::Point3d& p1, const CartWheel::Math::Point3d& p2, const CartWheel::Math::Vector3d& n, const CartWheel::Math::Vector3d& vParent,
			const CartWheel::Math::Vector3d& nParent, const CartWheel::Math::Vector3d& vChild, CartWheel::Math::Quaternion* qP, CartWheel::Math::Quaternion* qC);
