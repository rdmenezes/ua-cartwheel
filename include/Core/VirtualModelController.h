...
public:
	...
	*/
	void computeJointTorquesEquivalentToForce(CartWheel::Physics::Joint* start, const CartWheel::Math::Point3d& pLocal, const CartWheel::Math::Vector3d& fGlobal,
			CartWheel::Physics::Joint* end);
