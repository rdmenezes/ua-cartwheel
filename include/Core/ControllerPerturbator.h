...
public:
	//constructor...
	Perturbation(double* var, const char *PName, double w);
...
public:
	...
	void addPerturbation(DynamicArray<double*> *vars, const char* PName, double w);

	//adds a new perturbation to the collection...
	void addPerturbation(double *var, const char* PName, double w);
