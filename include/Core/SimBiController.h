...
*/
	...
	CartWheel::Math::Quaternion qRootD;
...
*/
	...
	CartWheel::Physics::RigidBody* stanceFoot;
	CartWheel::Physics::RigidBody* swingFoot;
	...
	CartWheel::Math::Vector3d doubleStanceCOMError;



	//now, for each foot (and toes if any), we will keep a summary of the contact points from the previous simulation
	CartWheel::Math::Vector3d forceStanceToe;
	CartWheel::Math::Vector3d forceSwingToe;
	CartWheel::Math::Vector3d forceStanceHeel;
	CartWheel::Math::Vector3d forceSwingHeel;
	CartWheel::Math::Point3d toeSwingPos;
	CartWheel::Math::Point3d toeStancePos;
	CartWheel::Math::Point3d heelSwingPos;
	CartWheel::Math::Point3d heelStancePos;
	...
	void computeToeAndHeelForces(DynamicArray<CartWheel::Physics::ContactPoint> *cfs);
	...
	CartWheel::Math::Quaternion characterFrame;
...
*/
	...
	*/
	virtual void parseGainLine(const char* line);
	...
	*/
	CartWheel::Math::Vector3d getForceOn(CartWheel::Physics::RigidBody* rb, DynamicArray<CartWheel::Physics::ContactPoint> *cfs);
...
//	bool isSwingFoot(CartWheel::Physics::RigidBody* rb);
	...
	*/
	double getStanceFootWeightRatio(DynamicArray<CartWheel::Physics::ContactPoint> *cfs);
	...
	/**
		...
		foot.
	*/
	void computeHipTorques(const CartWheel::Math::Quaternion& qRootD, double stanceHipToSwingHipRatio, CartWheel::Math::Vector3d ffRootTorque);
	...
	*/
	CartWheel::Physics::RigidBody* getRBBySymbolicName(const char* sName);
...
//		rootControlParams.setKd( sqrt(rootControlParams.getKp()) * 2 );
	...
	const CartWheel::Math::Vector3d& getDoubleStanceCOMError() const { return doubleStanceCOMError; }
	...
	*/
	 ...
	 */
	SimBiConState* getState( unsigned int idx );
	 ...
	 */
	unsigned int getStateCount() const { return states.size(); }
	...
	*/
	void computePDTorques(DynamicArray<CartWheel::Physics::ContactPoint> *cfs);
	...
	*/
	virtual int advanceInTime(double dt, DynamicArray<CartWheel::Physics::ContactPoint> *cfs);
	...
	*/
	...
	CartWheel::Math::Vector3d getV() const { return v; }
	CartWheel::Math::Vector3d getD() const { return d; }

	/**
		This method returns the position of the CM of the stance foot, in world coordinates
	*/
	inline CartWheel::Math::Point3d getStanceFootPos(){
		if (stanceFoot)
			return stanceFoot->getCMPosition();
		return CartWheel::Math::Point3d(0,0,0);
	}

	/**
		This method returns the position of the CM of the swing foot, in world coordinates
	*/
	inline CartWheel::Math::Point3d getSwingFootPos(){
		if (swingFoot)
	...
	*/
	void writeToFile(const char* fileName, const char* stateFileName = NULL);
	...
	*/
	CartWheel::Math::Quaternion getCharacterFrame(){
	...
	*/
	...
	inline void computeD0( double phi, CartWheel::Math::Vector3d* d0 ) {
	...
	inline void computeV0( double phi, CartWheel::Math::Vector3d* v0 ) {
		SimBiConState* currState = states[getFSMState()];
	...
	// Evaluate the V trajectory 
	inline static void computeDorV( double phi, CartWheel::Math::Trajectory1d* trajX, CartWheel::Math::Trajectory1d* trajZ, int stance, CartWheel::Math::Vector3d* result ) {
		result->y = 0;
