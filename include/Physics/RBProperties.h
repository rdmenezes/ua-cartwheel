...
public:
	...
	CartWheel::Math::Vector3d MOI_local;
	//we'll also compute the inverse MOI, in local coordinates
	CartWheel::Math::Vector3d invMOI_local;
...
public:
	...
	*/
	...
	const CartWheel::Math::Vector3d& getMOI() const { return MOI_local; }
	...
	*/
	...
	inline void getInverseLocalMOI(CartWheel::Math::Vector3d* res){
		res->setValues(invMOI_local.x, invMOI_local.y, invMOI_local.z);
	}

	inline void getLocalMOI(CartWheel::Math::Vector3d* res){
