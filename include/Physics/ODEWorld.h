//#pragma once
#ifndef CARTWHEEL_ODEWORLD_H
#define CARTWHEEL_ODEWORLD_H
...
extern void collisionCallBack(void* odeWorld, dGeomID o1, dGeomID o2);
...
public:
	...
	*/
	virtual void applyRelForceTo(RigidBody* b, const CartWheel::Math::Vector3d& f, const CartWheel::Math::Point3d& p);
	...
	*/
	virtual void applyForceTo(RigidBody* b, const CartWheel::Math::Vector3d& f, const CartWheel::Math::Point3d& p);
...
//PHYSICS_TEMPLATE( DynamicArray<CartWheel::Physics::ODE_RB_Map> )
