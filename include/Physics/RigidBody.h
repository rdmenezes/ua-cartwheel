...
protected:
	...
	CartWheel::Math::Vector3d externalForce;
	CartWheel::Math::Vector3d externalTorque;
...
public:
	...
	*/
	...
	void setExternalForce( const CartWheel::Math::Vector3d& ef ) { externalForce = ef; }

	void setExternalTorque( const CartWheel::Math::Vector3d& et ) { externalTorque = et; }

	const CartWheel::Math::Vector3d& getExternalForce() const { return externalForce; }

	const CartWheel::Math::Vector3d& getExternalTorque() const { return externalTorque; }
	...
	*/
	CartWheel::Math::Point3d getWorldCoordinates(const CartWheel::Math::Point3d& localPoint);
	...
	*/
	CartWheel::Math::Point3d getLocalCoordinates(const CartWheel::Math::Point3d& globalPoint);
	...
	*/
	CartWheel::Math::Vector3d getLocalCoordinates(const CartWheel::Math::Vector3d& globalVector);

	/**
		This method returns the vector that is passed in as a parameter(expressed in local coordinates), in world coordinates.
	*/
	CartWheel::Math::Vector3d getWorldCoordinates(const CartWheel::Math::Vector3d& localVector);
	...
	*/
	CartWheel::Math::Vector3d getAbsoluteVelocityForLocalPoint(const CartWheel::Math::Point3d& localPoint);
	...
	/**
		...
		resulting velocity will be expressed in world coordinates.
	*/
	CartWheel::Math::Vector3d getAbsoluteVelocityForGlobalPoint(const CartWheel::Math::Point3d& globalPoint);


	/**
		This method returns the world coordinates of the position of the center of mass of the object
	*/
	inline CartWheel::Math::Point3d getCMPosition(){
	...
	*/
	inline void setCMPosition(const CartWheel::Math::Point3d& newCMPos){
	...
	*/
	inline CartWheel::Math::Vector3d getCMVelocity(){
		return state.velocity;
	}

	inline void setOrientation(double angle, CartWheel::Math::Vector3d axis) {
		state.orientation = CartWheel::Math::Quaternion::getRotationQuaternion(angle, axis.toUnit()) * state.orientation;
	}

	/**
		This method sets the velocity of the center of mass of the object
	*/
	inline void setCMVelocity(const CartWheel::Math::Vector3d& newCMVel){
	...
	*/
	inline void setAngularVelocity(const CartWheel::Math::Vector3d& newAVel){
	...
	*/
	unsigned int renderToObjFile(FILE* fp, unsigned int vertexIdxOffset);


	/**
		This method loads all the pertinent information regarding the rigid body from a file.
	*/
	void loadFromFile(FILE* fp, const char* sPath);
	...
	*/
	...
	void addMesh( CartWheel::GL::GLMesh* mesh_disown ) {
	...
	CartWheel::GL::GLMesh* getMesh(unsigned int index) const {
	...
	*/
	void setMOI( CartWheel::Math::Vector3d moi ) {
		props.setMOI( moi.x, moi.y, moi.z );
	}

	const CartWheel::Math::Vector3d& getMOI() const { return props.getMOI(); }
	...
	*/
	void setFrictionCoefficient( double frictionCoefficient ) {
		if (frictionCoefficient<0)
			CartWheel::Util::throwError("Friction coefficient should be >= 0");
	...
	*/
	void setRestitutionCoefficient( double restitutionCoefficient ) {
		if (restitutionCoefficient<0 || restitutionCoefficient>1)
			CartWheel::Util::throwError("Restitution coefficient should be between 0 and 1");
...
//	void updateToWorldTransformation();
	...
	*/
	...
	/**
		...
		frame axes)
	*/
	inline CartWheel::Math::Vector3d getPMI(){
	...
	*/
	inline void setOrientation(CartWheel::Math::Quaternion q){
		state.orientation = q;
	}
	...
	*/
	...
	inline CartWheel::Math::Vector3d getScale() { return scale; }
	inline void setScale(CartWheel::Math::Vector3d newScale) { scale = newScale; }
...
//PHYSICS_TEMPLATE( DynamicArray<CartWheel::Physics::RigidBody*> )
