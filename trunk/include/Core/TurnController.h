...
protected:
	...
	double turnAngle;
	bool stillTurning;
	CartWheel::Math::Vector3d desiredVelocity;
	CartWheel::Math::Vector3d initialVelocity;
	//some quaternions that will be useful..
	CartWheel::Math::Quaternion currentHeadingQ, currentDesiredHeadingQ, finalHeadingQ, upperBodyTwistQ, tmpQ, tmpQ2;
