...
class BalanceFeedback : public CartWheel::Util::Observable {
public:
	...
	/**
		...
		the center of mass.
	*/
	virtual double getFeedbackContribution(SimBiController* con, CartWheel::Physics::Joint* j, double phi, CartWheel::Math::Vector3d d, CartWheel::Math::Vector3d v) = 0;
...
public:
	...
	CartWheel::Math::Vector3d feedbackProjectionAxis;
...
public:
	LinearBalanceFeedback(){
		feedbackProjectionAxis = CartWheel::Math::Vector3d();
		cd = cv = 0;
		vMin = dMin = -1000;
		vMax = dMax = 1000;
	}
	...
	void setProjectionAxis( const CartWheel::Math::Vector3d& axis ) {
		feedbackProjectionAxis = axis;
	}
	
	const CartWheel::Math::Vector3d& getProjectionAxis() const {
	...
	/**
		...
		the center of mass.
	*/
	virtual double getFeedbackContribution(SimBiController* /* con */, CartWheel::Physics::Joint* /* j */, double /* phi */, CartWheel::Math::Vector3d d, CartWheel::Math::Vector3d v){
