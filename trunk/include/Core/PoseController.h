...
namespace CartWheel {
    namespace Core {
         ...
         */
        class ControlParams : public CartWheel::Util::Observable {
        public:
            ...
            CartWheel::Math::Quaternion frame;
            CartWheel::Math::Vector3d frameAngularVelocityInWorld;
        ...
        public:
             ...
             */
            ControlParams(CartWheel::Physics::Joint* joint = NULL) {
                this->joint = joint;
                controlled = false;
                kp = kd = 0;
                maxAbsTorque = 0;
                scale = CartWheel::Math::Vector3d();
                strength = 1;
                relToFrame = false;
            ...
            CartWheel::Physics::Joint* getJoint() const {
                return joint;
            }

            bool setJoint(CartWheel::Physics::Joint* joint) {
            ...
            double getMaxAbsTorque() const {
                return maxAbsTorque;
            }

            void setScale(const CartWheel::Math::Vector3d& scale) {
                this->scale = scale;
                notifyObservers();
            }

            const CartWheel::Math::Vector3d& getScale() const {
                return scale;
            }
        ...
        public:
            ...
            virtual void addControlParams(const ControlParams& params) {
                ...
                if (jIndex < 0)
                    CartWheel::Util::throwError("Cannot find joint \'%s\' in character", params.getJointName());
            ...
            virtual void scaleGains(double factor) {
                for (unsigned int i = 0; i < controlParams.size(); ++i) {
                    if (strcmp("ToeJoint", character->getJoint(i)->getName() + 1) == 0)
                        continue;
             ...
             */
            static CartWheel::Math::Vector3d computePDTorque(const CartWheel::Math::Quaternion& qRel, const CartWheel::Math::Quaternion& qRelD, const CartWheel::Math::Vector3d& wRel, const CartWheel::Math::Vector3d& wRelD, ControlParams* pdParams);
             ...
             */
            static void scaleAndLimitTorque(CartWheel::Math::Vector3d* torque, ControlParams* pdParams, const CartWheel::Math::Quaternion& qToChild);
             ...
             */
            static void limitTorque(CartWheel::Math::Vector3d* torque, ControlParams* cParams);
