...
protected:
	...
	CartWheel::Math::Vector3d torque;
	...
	CartWheel::Math::Vector3d tmpV1, tmpV2, tmpV3, tmpV4, tmpV5;

	//and some tmp CartWheel::Math::Quaternions
	CartWheel::Math::Quaternion tmpQ1, tmpQ2, tmpQ3, tmpQ4;
	...
	*/
	virtual void fixAngularConstraint(const CartWheel::Math::Quaternion& qRel) = 0;
...
public:
	...
	*/
	...
	/**
		sets the torque
	*/
	inline void setTorque(const CartWheel::Math::Vector3d& t){torque = t;}
	...
	*/
	inline const CartWheel::Math::Point3d& getChildJointPosition(){return cJPos;}

	/**
		sets the position of the child joint, expressed in child's coordinates
	*/
	inline void setChildJointPosition( const CartWheel::Math::Point3d& cJPos ){
		this->cJPos = cJPos;
	}
	...
	*/
	void computeRelativeOrientation(CartWheel::Math::Quaternion& qRel);

	/**
		returns the position of the parent joint, expressed in parent's coordinates
	*/
	inline const CartWheel::Math::Point3d& getParentJointPosition(){return pJPos;}

	/**
		sets the position of the parent joint, expressed in parent's coordinates
	*/
	inline void setParentJointPosition( const CartWheel::Math::Point3d& pJPos ){
		this->pJPos = pJPos;
	}
...
//PHYSICS_TEMPLATE( DynamicArray<CartWheel::Physics::Joint*>  )
