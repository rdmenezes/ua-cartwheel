...
private:
	...
	CartWheel::Math::Capsule c;
	CartWheel::Math::Capsule wC;
public:
	CapsuleCDP(CartWheel::Math::Point3d& point1, CartWheel::Math::Point3d& point2, double radius, RigidBody* theBody = NULL) :
	...
	*/
	inline const CartWheel::Math::Point3d& getPoint1(){
		return c.p1;
	}

	inline void setPoint1( const CartWheel::Math::Point3d& point1 ) {
		c.p1 = point1;
	}
	...
	/**
		return the position of the first endpoint.
	*/
	inline const CartWheel::Math::Point3d& getPoint2(){
		return c.p2;
	}

	inline void setPoint2( const CartWheel::Math::Point3d& point2 ) {
		c.p2 = point2;
	}
