...
public:
	...
	CartWheel::Math::Sphere s;
	//and this is the sphere, expressed in world coordinates
	CartWheel::Math::Sphere wS;
public:
	SphereCDP(CartWheel::Math::Point3d& center, double radius, RigidBody* theBody = NULL ) :
	...
	*/
	inline const CartWheel::Math::Point3d& getCenter(){
		return s.pos;
	}

	inline void setCenter( const CartWheel::Math::Point3d& center ) {
		s.pos = center;
	}
