...
public:
	...
	*/
	...
	/**
		Sets the three axes
	*/
	void setAxes( const CartWheel::Math::Vector3d& swingAxis1, const CartWheel::Math::Vector3d& swingAxis2, const CartWheel::Math::Vector3d& twistAxis ) {
	...
	*/
	void setAxes( const CartWheel::Math::Vector3d& swingAxis1, const CartWheel::Math::Vector3d& twistAxis ) {
		setAxes( swingAxis1,
				 swingAxis1.crossProductWith(twistAxis),
				 twistAxis );
	}

	void setSwingAxis1( const CartWheel::Math::Vector3d& swingAxis1 )
	{
		this->swingAxis1 = swingAxis1;
		this->swingAxis1.toUnit();
		updateAxis2IfNeeded();
	...
	const CartWheel::Math::Vector3d& getSwingAxis1() const { return swingAxis1; }

	void setSwingAxis2( const CartWheel::Math::Vector3d& swingAxis2 )
	{
		if( swingAxis2.length() < 0.001 ) {
			this->desiredSwingAxis2 = CartWheel::Math::Vector3d(0,0,0);
			updateAxis2IfNeeded();
		}
		else {
			this->swingAxis2 = swingAxis2;
	...
	const CartWheel::Math::Vector3d& getSwingAxis2() const { return swingAxis2; }

	void setTwistAxis( const CartWheel::Math::Vector3d& twistAxis )
	{
		this->twistAxis = twistAxis;
		this->twistAxis.toUnit();
		updateAxis2IfNeeded();
	...
	const CartWheel::Math::Vector3d& getTwistAxis() const { return twistAxis; }
