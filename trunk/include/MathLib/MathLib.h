...
*/
#ifndef CW_EPSILON
#define CW_EPSILON 0.0000000001
#endif
...
*/
#define ZERO_WITHIN_EPSILON(x) ((x)>-CW_EPSILON && (x)<CW_EPSILON)


/**
	This macro checks to see if the value of x is less than y, within epsilon
*/
#define LESS_THAN_WITHIN_EPSILON(x,y) ((x)<(y)+CW_EPSILON)


/**
	This macro checks to see if the value of x is greater than y, within epsilon
*/
#define GREATER_THAN_WITHIN_EPSILON(x,y) ((x)>(y)-CW_EPSILON)
